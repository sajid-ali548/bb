             ...
             <div className='bg-white rounded-xl shadow-md relative'> 
                <div className='p-4'>
                  <div className='mb-6'>
                   ...
                   <div className='mb-5'>
                        We are seeking talented Front-End Developer 
                        to join our team 
                        in Boston, MA. The ideal candidate will have strong skills 
                        in HTML, CSS, JavaScript, React.Js...
                   </div>
                      
                   <h3 className='text-indigo-500 mb-2'>$70 - 80K / year
                   </h3>
